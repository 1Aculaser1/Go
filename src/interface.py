...
board_prev = pygame.image.load(os.path.join("src/images", "board_prev.png"))
main_logo1 = pygame.image.load(os.path.join("src/images", "main1.png"))
board_img1 = pygame.image.load(os.path.join("src/images", "board1.png"))
board_prev1 = pygame.image.load(os.path.join("src/images", "board1_prev.png"))
main_logo2 = pygame.image.load(os.path.join("src/images", "main2.png"))
board_img2 = pygame.image.load(os.path.join("src/images", "board2.png"))
board_prev2 = pygame.image.load(os.path.join("src/images", "board2_prev.png"))
